...
def tests_to_run(forwarder):
    from tests import BasicTest, RandomDropTest, SackRandomDropTest, DupTest, SackDupTest, ReorderTest, SackReorderTest, \
        FuckedUpLink, SackFuckedUpLink
    test_file = "README"
    # test_file = "Testfile"
    # test_file = "pic.png"
    BasicTest.BasicTest(forwarder, test_file)
    RandomDropTest.RandomDropTest(forwarder, test_file)
    DupTest.DupTest(forwarder, test_file)
    ReorderTest.ReorderTest(forwarder, test_file)
    FuckedUpLink.FuckedUpLink(forwarder, test_file)
    SackDupTest.SackDupTest(forwarder, test_file)
    SackReorderTest.SackReorderTest(forwarder, test_file)
    SackRandomDropTest.SackRandomDropTest(forwarder, test_file)
    SackFuckedUpLink.SackFuckedUpLink(forwarder, test_file)
